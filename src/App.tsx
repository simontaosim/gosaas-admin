...
import { Layout, CustomLogin } from "./layout";
...
const App = () => {
  ...
  return (<Admin dashboard={dashboard} dataProvider={dataProvider} authProvider={authProvider} layout={Layout}  i18nProvider={i18nProvider} loginPage={CustomLogin}>
